import WeatherEarthquakeSource from "../data/cuacaindb-source.js";

const Gempa = {
    async render() {
        return `
            <div class="gempa-container"></div>
        `;
    },

    async afterRender() {
        const responseGempa = await WeatherEarthquakeSource.getLatestEarthquake()
        const infoGempa = responseGempa[0].Infogempa.gempa;
        const listGempa = responseGempa[1].Infogempa.gempa;
